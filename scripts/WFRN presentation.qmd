...
::: notes
Drawing on investment model of commitment theory\
...
[**\<click\>**]{style="color: #E74C3C;"}\
First RQ: \[read it\]\
Descriptive statistics show men partnered with men are less likely to be living with a child.\
Pooling is more common with a breadwinner/homemaker work family arrangements, which might vary by couple-type.
Relative earnings differences is also gendered, which might have implications.
...
-   **Work-Family Arrangement**: <br> (1) Both full-time (2) Full-time/part-time (3) Full-time/not employed\
:::
...
2 scales of relationships quality: **Dissatisfaction** **Negativity**\
...
<h3>Take-away statement here</h3>
